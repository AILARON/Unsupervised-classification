...
def train_dcgan(batch_size, epochs, image_shape, dataset_path):
    ...
    optimizer = Adam(lr=0.0015, beta_1=0.5)
    ...
    for epoch in range(epochs):
        ...
        for batch_number in range(number_of_batches):
            ...
            #visualize_input(real_images)
            #save_generated_images(real_images, 1, 1)
            ...
            if (batch_number + 1) %50 == 0:
                visualize_input(generated_images)
...
def gan():
    dataset_path = 'dataset/kaggletrainoriginalfull/'
    batch_size = 32
    image_shape = (64, 64, 1)
    epochs = 190
